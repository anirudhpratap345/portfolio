  ...
  return (
    <footer className="py-12 relative">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          {/* Main Footer Content */}
          <div className="glass-card p-8 mb-8 max-w-2xl mx-auto relative overflow-hidden">
            {/* Background decoration */}
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                ...
                <h3 className="text-xl font-semibold gradient-text">Let's Connect</h3>
              </div>
              ...
              <div className="flex justify-center space-x-6">
                <a
                  ...
                  className="rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 border"
                  style={{
                    width: '48px',
                    height: '48px',
                    backgroundColor: 'var(--bg-secondary)',
